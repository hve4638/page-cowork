                    ...
                    <form onSubmit={e => { e.preventDefault(); submit(); }}>
                        {!isLogin && (
                            <div className="login-field">
                                ...
                                <input id="login-email" className="login-input" type="email" placeholder="name@example.com" autoComplete="email" value={email} onChange={e => setEmail(e.target.value)} />
                            </div>
                        )}
                        <div className="login-field">
                            <label htmlFor="login-id">아이디</label>
                            <input id="login-id" className="login-input" placeholder="아이디" autoComplete="username" autoFocus value={loginId} onChange={e => setLoginId(e.target.value)} />
                        </div>
                        <div className="login-field">
