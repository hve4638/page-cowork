...
export function GeminiIcon({ style = {} }: IconProps) {
    return <svg style={style} width="1.3em" height="1.3em" viewBox="0 0 256 256">
        <path fill="currentColor" d="M128 256c0-17.707-3.413-34.347-10.24-49.92-6.613-15.573-15.68-29.12-27.2-40.64s-25.067-20.587-40.64-27.2C34.347 131.413 17.707 128 0 128c17.707 0 34.347-3.307 49.92-9.92 15.573-6.827 29.12-16 40.64-27.52s20.587-25.067 27.2-40.64C124.587 34.347 128 17.707 128 0c0 17.707 3.307 34.347 9.92 49.92 6.827 15.573 16 29.12 27.52 40.64s25.067 20.693 40.64 27.52c15.573 6.613 32.213 9.92 49.92 9.92-17.707 0-34.347 3.413-49.92 10.24-15.573 6.613-29.12 15.68-40.64 27.2s-20.693 25.067-27.52 40.64C131.307 221.653 128 238.293 128 256Z"></path>
    </svg>
}
